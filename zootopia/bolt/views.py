...
def myaccount(request):
    # myaccount_list = UserProfile.objects.all()
    # context_dict = {}
    # context_dict['user'] = myaccount_list

    # visitor_cookie_handler(request)
    # context_dict['visits'] = request.session['visits']

    # response = render(request, 'bolt/myaccount.html', context=context_dict)
    # return response
    ...
    # return render(request, "bolt/myaccount.html")



def fqa(request):
    return render(request,"bolt/fqa.html")
